<div class="row">
    ...
    <div class="col-sm-6">
        <div class="row">
            ...
            <p><?=$album->label?></p>
<!--            <button type="button" id="label_name" value="--><?php// echo $album->label?><!--" class="btn btn-success"><span class="oi" data-glyph="star" title="star" aria-hidden="true"></span>レーベルをお気に入りに追加する</button>-->
        </div>
